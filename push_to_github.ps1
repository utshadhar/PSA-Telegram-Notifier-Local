...
if ($remotes -contains "origin") {
    & $git remote set-url origin https://github.com/utshadhar/PSA-Telegram-Notifier-Local.git
} else {
    & $git remote add origin https://github.com/utshadhar/PSA-Telegram-Notifier-Local.git
}
